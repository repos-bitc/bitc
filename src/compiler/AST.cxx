...
static const unsigned char *astMembers[] = {
  ...
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x20\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_typeapp
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x40\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_exceptionType
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_dummyType
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_identPattern
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_tqexpr
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_unit
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_suspend
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_makevectorL
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x20\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_vector
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x40\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_array
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00", // at_begin
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00", // at_select
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00", // at_fqCtr
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x00", // at_sel_ctr
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00", // at_array_nth
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x00\x00", // at_vector_nth
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x20\x00\x00\x00\x00\x00\x00\x00\x00", // at_array_length
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x40\x00\x00\x00\x00\x00\x00\x00\x00", // at_vector_length
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00", // at_lambda
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00", // at_argVec
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00", // at_apply
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00", // at_struct_apply
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00\x00\x00\x00\x00\x00\x00", // at_ucon_apply
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x00", // at_if
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x20\x00\x00\x00\x00\x00\x00\x00", // at_when
  ...
  (unsigned char *)"\x00\x0c\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00", // agt_CompilationUnit
  (unsigned char *)"\x00\xf0\x03\x03\xfa\x09\x00\x00\x00\x00\x00\x00\x00\x00\x00\xe0\x03\x00", // agt_definition
  (unsigned char *)"\x00\xf0\x03\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x40\x00\x00", // agt_type_definition
  (unsigned char *)"\x00\x00\x00\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x00\x00", // agt_tc_definition
  (unsigned char *)"\x00\x00\x00\x00\x30\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00", // agt_value_definition
  (unsigned char *)"\x00\x00\x00\x00\xc8\x09\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00", // agt_if_definition
  (unsigned char *)"\x00\x00\xe0\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x04\x00", // agt_category
  (unsigned char *)"\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00", // agt_fielditem
  (unsigned char *)"\x14\x00\x00\x80\x00\x00\xf8\xfd\x00\x00\x00\x00\x00\x00\x00\x0a\x30\x00", // agt_qtype
  (unsigned char *)"\x14\x00\x00\x00\x00\x00\xf8\xfd\x00\x00\x00\x00\x00\x00\x00\x0a\x20\x00", // agt_type
  (unsigned char *)"\xf4\x03\x00\x00\x00\x00\x00\x00\xfe\xff\xfe\xe3\x3f\x67\x50\x06\x40\x01", // agt_expr
  (unsigned char *)"\xf4\x03\x00\x00\x30\x00\x00\x00\xfe\xff\xfe\xe3\x3f\x67\x50\x06\xc0\x01", // agt_expr_or_define
  (unsigned char *)"\xf4\x03\x00\x00\x00\x00\x00\x00\xfc\xff\xfe\xe3\x3f\x67\x50\x06\x00\x01", // agt_eform
  (unsigned char *)"\x14\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x00\x00\x02\x00\x02", // agt_ucon
